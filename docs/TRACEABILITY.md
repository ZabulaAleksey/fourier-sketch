...
| `BH-ADAPTIVE-001` | FC-FR-009, FC-AC-007, IM-FR-010, IM-AC-010 | FS-028 | weighted arc-length density with exact N and uniform comparison | unit + property + integration + component + live CLI E2E + performance/full/static/overlay | verified on working branch; independent review GO; awaiting publication |
