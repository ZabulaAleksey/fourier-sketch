...
| `BH-SOLO-001` | UI-FR-012, UI-AC-009, EP-FR-008, EP-AC-007 | FS-025 | one-frequency analysis session over immutable baseline frame | unit + property + component + actual Qt offscreen E2E + full/static/overlay | verified locally; independent re-review GO, integration pending |
